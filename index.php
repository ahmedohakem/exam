...
window.onload = function() {
  document.getElementById("univid").focus();
};    </script>
...
<p>&nbsp;</p>
 ...
 ?>
 <br><br>
            <input id="univid" type="text" name="univid" placeholder="Enter University ID Here" required/>
			<p>&nbsp;</p>
<p>&nbsp;</p>
<input type = 'submit' value = 'Begin Exam' style='height: 44px; width: 200px; font-size:100%;font-family:big'>
      </form>
    </div>
